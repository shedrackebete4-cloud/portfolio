  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Portfolio of Shedrack Ebete — project and operations leader, tech-enabled trainer across FMCG, consulting, fitness, and fashion.",
      },
